...
class InstaBot:
    ...
    def __init__(self,
        ...
        fake_ua = "Mozilla/5.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/4.0; GTB7.4; InfoPath.2; SV1; .NET CLR 3.3.69573; WOW64; en-US)"
        self.user_agent = check_and_insert_user_agent(self, fake_ua)
